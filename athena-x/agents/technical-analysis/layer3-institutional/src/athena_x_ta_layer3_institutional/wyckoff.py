"""Wyckoff Agent - Layer 3 (Institutional Analysis).

Detects Wyckoff accumulation/distribution phase
...
class WyckoffAgent(BaseTAAgent):
    """Detects Wyckoff accumulation/distribution phase"""

    def __init__(self, **kwargs):
        super().__init__(name="wyckoff", layer=3, **kwargs)
