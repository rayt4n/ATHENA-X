"""ChanTheory Agent - Layer 3 (Institutional Analysis).

Chan Theory (Bi/Duan/Zhongshu) analysis
...
class ChanTheoryAgent(BaseTAAgent):
    """Chan Theory (Bi/Duan/Zhongshu) analysis"""

    def __init__(self, **kwargs):
        super().__init__(name="chan_theory", layer=3, **kwargs)
    ...
    async def compute(self, symbol: str, timeframe: Timeframe, repo) -> TAOutput:
        ...
        if len(closes) < 20:
            return TAOutput(
                ...
                indicator="ChanTheory", value=None,
        ...
        elif "chan_theory" == "pull_up_pattern":
