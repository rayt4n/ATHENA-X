"""ElliottWave Agent - Layer 3 (Institutional Analysis).
...
class ElliottWaveAgent(BaseTAAgent):
    """Elliott Wave pattern recognition"""

    def __init__(self, **kwargs):
        super().__init__(name="elliott_wave", layer=3, **kwargs)
    ...
    async def compute(self, symbol: str, timeframe: Timeframe, repo) -> TAOutput:
        ...
        if len(closes) < 20:
            return TAOutput(
                ...
                indicator="ElliottWave", value=None,
        ...
        elif "elliott_wave" == "pull_up_pattern":
