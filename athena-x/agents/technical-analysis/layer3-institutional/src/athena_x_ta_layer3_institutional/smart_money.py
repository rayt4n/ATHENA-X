"""SmartMoney Agent - Layer 3 (Institutional Analysis).
...
class SmartMoneyAgent(BaseTAAgent):
    """Smart Money Concepts (order blocks, FVGs)"""

    def __init__(self, **kwargs):
        super().__init__(name="smart_money", layer=3, **kwargs)
    ...
    async def compute(self, symbol: str, timeframe: Timeframe, repo) -> TAOutput:
        ...
        if len(closes) < 20:
            return TAOutput(
                ...
                indicator="SmartMoney", value=None,
        ...
        elif "smart_money" == "pull_up_pattern":
